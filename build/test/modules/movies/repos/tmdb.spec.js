...
const subtypes_1 = require("../../../../src/modules/movies/entities/subtypes");
...
describe("getMovieById(id)", () => {
    test("given a valid TMDB id returns a movie", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect((_c = result.getValue()) === null || _c === void 0 ? void 0 : _c.background).toBeInstanceOf(subtypes_1.MovieImage);
        ...
        expect((_k = result.getValue()) === null || _k === void 0 ? void 0 : _k.poster).toBeInstanceOf(subtypes_1.MovieImage);
...
describe("getMoviesByRealeaseDate(startDate, endDate)", () => {
    test("given valid start and end dates TMDB returns an array of movies", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        for (const movie of result.getValue() || []) {
            ...
            expect(movie.background).toBeInstanceOf(subtypes_1.MovieImage);
            ...
            expect(movie.poster).toBeInstanceOf(subtypes_1.MovieImage);
...
const firstLanguage = new subtypes_1.Language("en", "639-1");
const secondLanguage = new subtypes_1.Language("fr", "639-1");
const invalidLanguage = new subtypes_1.Language("--", "639-1");
