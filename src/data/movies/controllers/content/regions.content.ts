...
export default {
    ...
    "Europe": {
      ...
      "subtitle": "Embark on a Cinematic Journey through the Diverse Landscapes of Europe"
    },
    "Balkans": {
      "title": "Balkan Chronicles",
      "subtitle": "Explore Unique and Compelling Films from the Balkan Peninsula"
    },
    "Greece": {
      "title": "Hellenic Heritage on Screen",
      "subtitle": "Experience the Rich Cultural Legacy and Stories of Greece"
    },
    "Eastern Europe": {
      "title": "Contemporary Eastern Europe",
      "subtitle": "Immerse Yourself in the Cinematic Exploration of Modern Eastern Europe"
    },
    "Middle East & North Africa": {
      "title": "Cinematic Wonders of the Middle East and North Africa",
      "subtitle": "Discover the Richness and Diversity of Films from the Region"
    },
    "Africa": {
      "title": "African Cinematic Tapestry",
      "subtitle": "Celebrate the Vibrant and Compelling Films from the Continent"
    },
    "Indian Subcontinent": {
      "title": "Journey through the Indian Subcontinent",
      "subtitle": "Experience the Magic and Grandeur of Films from the Subcontinent"
    },
    "Asia": {
    ...
    "South America": {
      ...
      "subtitle": "Explore the Colorful and Passionate Films from South America"
    },
    "Oceania": {
