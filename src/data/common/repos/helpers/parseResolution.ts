...
import { Resolution, fuzzyMatchResolution } from "../../../../domain/common/entities/resolution";
import torrentTitleParser from "parse-torrent-title"
import * as E from 'fp-ts/Either'
import * as t from 'io-ts'

export const parseResolution : (torrent: {name?: string, title?: string}) => t.TypeOf<typeof Resolution> = (torrent) => pipe(
    torrent,
